...
window.__packs['en'] = {
  ...
  appTitle:'3D Editor',
  // Manual reader
  tabGuide:'Guide', tabManual:'Manual', manTitle:'User Manual', manToc:'Contents', manLine:'Line', manGotoPh:'Go to line', manGoto:'Go', manSearchPh:'Search…', manNote:'Notes', manHi:'Highlight', manCopy:'Copy', manCopyAll:'Copy All', manZoomIn:'Zoom In', manZoomOut:'Zoom Out', manClose:'Close', manLoading:'Loading…', manLoadFail:'Failed to load the manual. Please check your network.', manCurLine:'Current line', manNoNote:'No notes', manNotePh:'Note…', manSave:'Save', manDelete:'Delete', manJump:'Jump', manOpenExt:'Open on GitHub', manAdded:'Note added', manDeleted:'Note deleted', manCopied:'Copied', manNext:'Next', manNoteAt:'Line {0}', manUnHl:'Highlight removed',
};
