...
window.__packs['ja'] = {
  ...
  aboutRepo:'GitHubリポジトリ', aboutCopyright:'Copyright © 2026-Present Yushichadao. All Rights Reserved.', aboutAuthor:'作者', aboutAI:'AI支援', aboutAIText:'TRAE と CodeBuddy ツールの AI 機能で生成を支援', tosLink:'利用規約', disclaimerLink:'免責事項', privacyLink:'プライバシーポリシー', tosBody:'本ツールの利用により、お客様は以下の条件に同意したものとみなします：本ツールは個人の学習・クリエイティブ制作・非商用目的のみに提供されます；アップロードまたは作成したコンテンツについて、第三者の権利を侵害しないことなどの責任は利用者に帰属します；弊社は事前の通知なく本サービスを変更または中止する権利を有します。法令を遵守し、責任を持ってご利用ください。', disclaimerBody:'本ツールは「現状有姿」で提供され、可用性・正確性・特定目的への適合性についていかなる明示的または黙示的な保証もいたしません。本ツールの利用に伴い生じたいかなる直接的または間接的な損害についても、開発者は一切の責任を負いません。', privacyBody:'当社はお客様のプライバシーを重視します。本ツールは純粋なフロントエンドアプリケーションであり、すべての 3D モデル・テキスト・画像・シーン情報はお客様のブラウザ内でローカルに処理・保存され、いかなるサーバーにも送信されることはありません。当社は個人情報を収集・保存・共有することはありません。GitHub などの第三者リンクについては、各社のプライバシーポリシーをご参照ください。',
  ...
  declAuthor:'作者', declAI:'AI支援', declAIText:'TRAE と CodeBuddy ツールの AI 機能で生成を支援', declUpdate:'最終更新日',
