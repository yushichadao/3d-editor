...
window.__packs['zh-TW'] = {
  ...
  hintMultiAllNoColor:'目前{0}個物件「全部為無顏色」，已隱藏「不透明度控制、圖案/紋理欄」（僅支援「有顏色物件」，解除操作：直接點選顏色重新上色）',
  hintMultiSomeNoColor:'目前包含{0}個「無顏色物件」，已隱藏「不透明度控制、圖案/紋理欄」（僅支援「有顏色物件」，解除操作：為無顏色物件重新上色）',
